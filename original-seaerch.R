...
keywords <- c("woman", "women", "married", "girl", "diseases", "contagious", "marriages", "vagrancy")
...
write_csv(all_year_counts, "~/all_year_counts_resocsv")
...
write_csv(all_year_counts, "~/kw_list_resources.csv")
