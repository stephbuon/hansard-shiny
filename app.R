...
server <- function(input, output, session) {
  ...
  nations_count <- fread("~/projects/hansard-shiny/app-data/nations/hansard_c19_debate_title_nation_count.csv")
  
  nations_count$decade <- as.character(nations_count$decade)
  
  nation_pairs <- fread("~/projects/hansard-shiny/app-data/nations/nation_pairs_in_debate_titles.csv")
  ...
  speaker_favorite_words_count <- fread("~/projects/hansard-shiny/app-data/speakers/clean_speaker_favorite_words_by_decade.csv")
  ...
  output$top_speakers <- renderPlotly({ 
    ...
    top_speakers <- fread(paste0("~/projects/hansard-shiny/app-data/speakers/top_speakers_", input$top_speakers_df, ".csv"))
  ...
  longest_speeches <- fread("~/projects/hansard-shiny/app-data/speakers/longest_speeches.csv")
  ...
  longest_debates <- fread("~/projects/hansard-shiny/app-data/debates/longest_debates.csv")
  zz <- fread("~/projects/hansard-shiny/app-data/debates/clean_longest_debates_wordcloud.csv")
