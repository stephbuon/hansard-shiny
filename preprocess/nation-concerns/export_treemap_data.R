...
export_treemap_data <- function(preprocess_data_dir, nations_data) {
  
  test <- read_csv(paste0(preprocess_data_dir, nations_data)) %>%
    drop_na(geograpthy)
...
export_treemap_data(preprocess_data_dir, "nation_concerns_count.csv")
